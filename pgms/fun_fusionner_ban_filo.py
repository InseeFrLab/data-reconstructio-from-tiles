...
def intersect_ban_avec_carreaux(
    ...
    Args:
        ban (DataFrame): Le DataFrame contenant les points de la BAN, il suffit que les colonnes x et y soient présentes.
        polygons_gdf (GeoDataFrame): Le GeoDataFrame contenant les polygones avec une colonne "geometry".
        polygon_id_col (str): Le nom de la colonne identifiant les polygones dans `polygons_gdf`.
